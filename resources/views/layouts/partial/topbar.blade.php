...
// $admin_notifications= HomeController::getNotifications();
		...
		<ul class="navbar-item flex-row ml-auto">
			...
			<li class="nav-item dropdown language-dropdown">
				<a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown"
				   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					{{--<img src="{{ asset('assets/en/img/ca.png') }}" class="flag-width" alt="flag">--}}
					<i class="fa fa-globe mt-3"></i>
				</a>
				<div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
					@foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
					<a class="dropdown-item d-flex" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"><img src="{{ asset('assets/'.$localeCode.'/img/'.$localeCode.'.png') }}"
							 class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;{{$properties['native']}}</span></a>
					@endforeach
			...
			<li class="nav-item dropdown notification-dropdown">
				<a  href="" class="nav-link dropdown-toggle" id="notificationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<span class="badge badge-success ">{{ $admin_notifications->count()  }}</span>
				...
				<div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="notificationDropdown">
					<div class="notification-scroll">
						...
						<span id="readMsg" href="" data-notification_id='{{$notification->id}}'>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<div class="notification-meta-time">
										{{ $notification->getCreatedAtAttribute($notification->created_at) }} 
										</div>
								</div>
							</div> <br>
						</div>
						...
						@endforeach --}}
						<a href="{{ route('unreadNotifications') }}" class="dropdown-item dropdown-footer">@lang('general.see_all')</a>
					</div>
				</div>
						...
						<div class="notification-scroll">
							<div class="dropdown-item ">
								<div class="media">
									<div class="media-body">
										<div class="notification-para">
											<span class="">@lang('general.no_notifications') </span>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="userProfileDropdown">
					<div class="user-profile-section">                            
						<div class="media mx-auto">
							<img src="{{ asset('assets/en/img/90x90.jpg') }}" class="img-fluid mr-2" alt="avatar">
							<div class="media-body">
								<h5>Alan Green</h5>
								<p>Web Developer</p>
							</div>
